...
import { Experience as CVExperience } from "../cv"; // Assuming Experience is exported as CVExperience
...
const ExperienceSection: React.FC<Props> = ({ Data }) => {
    return (
        <section id="experience" className="my-10">
            <h2 className="text-3xl font-bold py-2 mb-2">Experience</h2>
...
const ExperienceTimeline: React.FC<{ Data: CVExperience[] }> = ({ Data }) => {
